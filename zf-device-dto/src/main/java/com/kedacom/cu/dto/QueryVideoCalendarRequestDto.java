...
public class QueryVideoCalendarRequestDto extends RecBaseVo implements Serializable {
    ...
    @NotBlank(message = "录像开始时间不能为空 例如：Tue Nov 30 15:52:34 CST 2021")
    @ApiModelProperty(value = "录像开始时间", required = true)
    private Date startTime;

    @NotBlank(message = "录像结束时间不能为空 例如：Tue Nov 30 15:52:34 CST 2021")

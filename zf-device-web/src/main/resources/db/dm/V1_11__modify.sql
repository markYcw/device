...
ab_name VARCHAR(128 CHAR) NOT NULL ,
ab_ip VARCHAR(32 CHAR) NOT NULL ,
ab_port INT NOT NULL ,
ab_pinyin VARCHAR(255 CHAR) DEFAULT NULL ,
ab_desc VARCHAR(125 CHAR) DEFAULT NULL ,

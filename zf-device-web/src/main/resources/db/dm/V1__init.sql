...
media_port INT DEFAULT NULL ,
group_id VARCHAR(32 CHAR) DEFAULT NULL ,
streaming_media_ip VARCHAR(32 CHAR) DEFAULT NULL ,
streaming_media_port INT DEFAULT NULL ,
streaming_media_rec_port INT DEFAULT NULL ,
...
manufactor_code INT DEFAULT NULL ,
...
install_date DATETIME(6) DEFAULT NULL ,

...
"dev_ip" VARCHAR(50) DEFAULT NULL ,
"dev_port" INT4 DEFAULT NULL ,
"notify_ip" VARCHAR(50) DEFAULT NULL ,
"media_schedule_ip" VARCHAR(50) DEFAULT NULL ,
"media_schedule_port" INT4 DEFAULT NULL ,
"nmedia_ip" VARCHAR(50) DEFAULT NULL ,
"nmedia_port" INT4 DEFAULT NULL ,
"rec_port" INT4 DEFAULT NULL ,
"dev_type" INT4 DEFAULT NULL ,
"msp_account" VARCHAR(128) DEFAULT NULL ,
"msp_password" VARCHAR(128) DEFAULT NULL ,

...
"id" INT4 NOT NULL DEFAULT NEXTVAL('km_power_config_id'::REGCLASS) ,
"port" INT4 DEFAULT NULL ,
"create_time" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ,
"update_time" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ,
PRIMARY KEY ("id") 
);
CREATE INDEX "port_unique_index" ON "km_power_config"USING BTREE("port");
...
INSERT INTO "km_power_config"VALUES (1, 9998, '2021-06-04 08:58:13', '2022-06-07 13:39:06');
...
CREATE SEQUENCE IF NOT EXISTS "km_power_device_id";
CREATE TABLE "km_power_device"(
"id" INT4 NOT NULL DEFAULT NEXTVAL('km_power_device_id'::REGCLASS) ,
"name" VARCHAR(64 CHAR) DEFAULT NULL ,
"ip" VARCHAR(15 CHAR) DEFAULT NULL ,
"mac" VARCHAR(128 CHAR) DEFAULT NULL ,
"channels" INT4 DEFAULT NULL ,
...
CREATE INDEX "mac_ip_group_unique_index" ON "km_power_device"USING BTREE("mac","ip");

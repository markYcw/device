ALTER TABLE "ums_new_group" ALTER COLUMN "group_id" TYPE  VARCHAR(512 CHAR);
...
ALTER TABLE "ums_new_group" ALTER COLUMN "parent_id" TYPE  VARCHAR(512 CHAR);
...
ALTER TABLE "ums_new_sub_device" ALTER COLUMN "group_id" TYPE  VARCHAR(1024 CHAR);

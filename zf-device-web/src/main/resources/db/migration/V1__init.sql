...
(
    ...
    `device_ip`                   varchar(15)  DEFAULT NULL COMMENT '平台IP',
    `device_port`                 int          DEFAULT NULL COMMENT '平台端口',
    `device_notify_ip`            varchar(15)  DEFAULT NULL COMMENT '设备状态订阅IP',
    `media_ip`                    varchar(15)  DEFAULT NULL COMMENT '媒体调度服务IP',
    `media_port`                  int          DEFAULT NULL COMMENT '媒体调度服务端口',
    `group_id`                    varchar(32)  DEFAULT NULL COMMENT '分组Id，关联ums_new_group表',
    `kafka_addr`                  varchar(128) DEFAULT NULL COMMENT '设备状态订阅信息',
    `streaming_media_ip`          varchar(15)  DEFAULT NULL COMMENT '流媒体服务IP',
